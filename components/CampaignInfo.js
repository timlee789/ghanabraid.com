...
function CampaignInfo({campaign2}) {
  ...
  return (
    <div className='m-8'>
       <div className='my-8  pl-16 text-blue-600 text-3xl'>NEW CAMPAIGN</div>
      ...
      <form >
      <div className='my-8  pl-16 text-blue-600 text-3xl'>CAMPAIGN HISTORY</div>
      <table>
        <thead>
        ...
        <tbody>    
               ...
               { campaign2.campaign.map((cam, index) => (
               <tr key={cam.id}>
                    ...
                    {/* <button className='my-8  pl-16 text-red-600 text-3xl' onClick={submitDelete(cam._id)}>Delete</button> */}
                    </td>
